...
let runCommand = (taskStrategyName, phenotype, cb) => {
  ...
  let strategyArgs = {
    ...
    trend_ema_new: `--trend_ema=${phenotype.trend_ema} --neutral_rate=${phenotype.neutral_rate} --neutral_rate_min=${phenotype.neutral_rate_min} --decision=${phenotype.decision}`,
