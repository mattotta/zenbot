...
let runCommand = (taskStrategyName, phenotype, cb) => {
  ...
  let strategyArgs = {
    ...
    trend_ema: `--markdown_buy_pct=${phenotype.markdown_buy_pct} --markup_sell_pct=${phenotype.markup_sell_pct} --order_type=${phenotype.order_type} --min_periods=${phenotype.min_periods} --trend_ema=${phenotype.trend_ema} --oversold_rsi=${phenotype.oversold_rsi} --oversold_rsi_periods=${phenotype.oversold_rsi_periods} --neutral_rate=${phenotype.neutral_rate} --neutral_rate_min=${phenotype.neutral_rate_min} --reversed=${phenotype.reversed}`,
    trend_ema_new: `--markdown_buy_pct=${phenotype.markdown_buy_pct} --markup_sell_pct=${phenotype.markup_sell_pct} --order_type=${phenotype.order_type} --trend_ema=${phenotype.trend_ema} --neutral_rate=${phenotype.neutral_rate} --neutral_rate_min_1=${phenotype.neutral_rate_min_1} --neutral_rate_min_2=${phenotype.neutral_rate_min_2} --decision=${phenotype.decision} --order_type_weak=${phenotype.order_type_weak} --order_type_strong=${phenotype.order_type_strong}`,
...
let strategies = {
  ...
  multi_ema: {
    ...
    // -- strategy
    ema_type_weak: RangeItems(['ema', 'ta_ema']),
    ema_type_strong: RangeItems(['ema', 'ta_ema']),
